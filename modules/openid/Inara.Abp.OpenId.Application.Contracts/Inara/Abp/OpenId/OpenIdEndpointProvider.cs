...
{
    private const String NotFound = $"{nameof(OpenIdServiceCollectionExtensions.AddInaraOpenIdEndpoints)} was called but the '{OpenIdDefaults.ApplicationsKey}' section was not found in any of the configuration providers.";
