...
namespace Dkw.Abp.Templates;

public class TemplateException : DkwException
{
    ...
    public TemplateException(ErrorCode errorCode, String message, Exception innerException)
