...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("TestApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "TestApp", DisplayName = "TestApp API", Resources = { "TestApp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var blazorClientId = configurationSection["TestApp_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["TestApp_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["TestApp_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["TestApp_Swagger:RootUrl"]?.TrimEnd('/');
