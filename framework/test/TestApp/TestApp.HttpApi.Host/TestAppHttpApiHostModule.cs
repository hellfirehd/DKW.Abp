...
public class TestAppHttpApiHostModule : AbpModule
{
    ...
    {
        Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "TestApp:"; });
    }
    ...
    private static void ConfigureSwaggerServices(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAbpSwaggerGenWithOAuth(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "TestApp API", Version = "v1" });
    ...
    {
        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("TestApp");
        if (!hostingEnvironment.IsDevelopment())
        {
            var redis = ConnectionMultiplexer.Connect(configuration["Redis:Configuration"]!);
            dataProtectionBuilder.PersistKeysToStackExchangeRedis(redis, "TestApp-Protection-Keys");
        }
    }
